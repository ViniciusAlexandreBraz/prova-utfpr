...
```
DEPLOY_ENV=prod
DEPLOY_HOST=prova-utfpr.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    prova-utfpr.example.com:
      ansible_user: root
      host: prova-utfpr
      hostname: prova-utfpr.example.com
```
...
Deploy the stack defined in `devops/stacks/prova-utfpr.example.com.yml` to the remote server with:
